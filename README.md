...
1. [Overview](#overview)
2. [Supported input datasets](#supported-input-datasets)
3. [Requirements](#requirements)
4. [Input pre-processing](#input-pre-processing)
5. [Usage](#usage)
6. [Command line arguments](#command-line-arguments)
7. [Flag details & examples](#flag-details--examples)
8. [Output files](#output-files)
9. [JSON configuration files](#json-configuration-files)
10. [Categories JSON file](#categories-json-file)
11. [Conditions JSON file](#conditions-json-file)
12. [Additionally generated columns](#additionally-generated-columns)
13. [Pharmacy summary table](#pharmacy-summary-table)
14. [Diagnosis summary table](#diagnosis-summary-table)
...
- Main filtered output table: filtered_table.tsv/xlsx
- Included patient IDs: ids_list.tsv/xlsx  

Optional outputs:  

- Pharmacy summary table: pharma_summary_table.tsv/xlsx
- Diagnosis summary table: diagnosis_summary_table.tsv/xlsx  
